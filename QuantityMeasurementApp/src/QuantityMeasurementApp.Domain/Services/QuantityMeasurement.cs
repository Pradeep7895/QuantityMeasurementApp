    ...
    public class QuantityMeasurement
{
    // Equality API
        ...
        // Comparison API
        public static bool demonstrateLengthComparison(double value1, LengthUnit unit1, double value2, LengthUnit unit2)
        {
        ...
        public static Length demonstrateLengthAddition(double value1, LengthUnit unit1, double value2, LengthUnit unit2)
        {
            var l1 = new Length(value1, unit1);
            var l2 = new Length(value2, unit2);
